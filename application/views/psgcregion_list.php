...
<div class="content-page">
    ...
    <div class="content">
        <div class="page-heading">
            <h1><i class='icon-address-book-alt'></i>Region</h1>
        </div>
                        ...
                        <div class="table-responsive">
                            <table id="grid-data" class="table table-hover table-striped" data-toggle="bootgrid" data-ajax="true" data-url="/users/server">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="##" data-title="commands" data-formatter="linkprov"></th>
                                    <th data-column-id="region_id">ID</th>
                                    <th data-column-id="region_psgc">PSGC</th>
                                    <th data-column-id="region_name">Name</th>
                                    <th data-column-id="region_nick">Nickname</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <script>
            gridSettings =
            {
                ...
                selection: false,
                sorting: true,
                url: "<?php echo base_url('psgc_region/renderregionlist'); ?>",
                ...
                formatters: {
                    ...
                    "linkprov" : function(column, row) {
                        //return "<a class='btn btn-outline-info btn-sm' href='#'><span> EDIT </span></a>";
                        return "<a class='btn btn-success btn-sm' href='<?php echo base_url('psgc_region/prov_index/'); ?>/" + row.region_id + "'><span> Provinces </span></a>";
                    }
