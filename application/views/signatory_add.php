            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Position code -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Signatory position" name="x_signatory_position" id="x_signatory_position" maxlength="50" value="<?php echo set_value('x_signatory_position'); ?>">
                        </div>
                    </div> <!-- ./Position code -->
                    <div class="form-group"> <!-- Position name -->
                        <label for="input-text" class="col-sm-2 control-label">Signatory name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Signatory name" name="x_signatory_name" id="x_signatory_name" maxlength="50" value="<?php echo set_value('x_signatory_name'); ?>">
                        </div>
                    </div> <!-- ./Position name -->
