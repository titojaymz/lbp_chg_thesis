...
<div class="content-page">
    ...
    <div class="content">
        <div class="page-heading">
            <h1><i class='icon-address-book-alt'></i>Provinces</h1>
        </div>
                        ...
                        <div class="table-responsive">
                            <table id="grid-data" class="table table-hover table-striped" data-toggle="bootgrid" data-ajax="true" data-url="/users/server">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="##" data-title="commands" data-formatter="linkmunicity"></th>
                                    <th data-column-id="prov_id">ID</th>
                                    <th data-column-id="region_id">Region ID</th>
                                    <th data-column-id="prov_psgc">PSGC</th>
                                    <th data-column-id="prov_name">Name</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <script>
            gridSettings =
            {
                ...
                selection: false,
                sorting: true,
                url: "<?php echo base_url('psgc_region/renderProvList/' . $region_id); ?>",
                ...
                formatters: {
                    ...
                    "linkmunicity" : function(column, row) {
                        //return "<a class='btn btn-outline-info btn-sm' href='#'><span> EDIT </span></a>";
                        return "<a class='btn btn-success btn-sm' href='<?php echo base_url('psgc_region/muni_city_index/'); ?>/" + row.prov_id + "'><span> Muni-City </span></a>";
                    }
