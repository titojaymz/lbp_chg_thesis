...
<div class="content-page">
    ...
    <div class="content">
        <div class="page-heading">
            <h1><i class='icon-cogs'></i>Farmer beneficairy</h1>
        </div>
        ...
        */ ?>
            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Last name -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_lastname" id="x_lastname" value="<?php echo $fbdata->lastname ?>">
                        </div>
                    </div> <!-- ./Last name -->
                    <div class="form-group"> <!-- First name -->
                        <label for="input-text" class="col-sm-2 control-label">First name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_firstname" id="x_firstname" value="<?php echo $fbdata->firstname ?>">
                        </div>
                    </div> <!-- ./First name -->
                    <div class="form-group"> <!-- Middle name -->
                        <label for="input-text" class="col-sm-2 control-label">Middle name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_middlename" id="x_middlename" value="<?php echo $fbdata->middlename ?>">
                        </div>
                    </div> <!-- ./Middle name -->
                    <div class="form-group"> <!-- Extension name -->
                        <label for="input-text" class="col-sm-2 control-label">Extension name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_extname" id="x_extname" value="<?php echo $fbdata->extname ?>">
                        </div>
                    </div> <!-- ./Extension name -->
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="x_region_id" id="x_region_id" onchange="getProvince()" required>
                                ...
                                <?php foreach($lib_regions as $regionlist): ?>
                                    <option <?php echo ($regionlist->region_id == $fbdata->region_id) ? 'selected' : '' ?> value="<?php echo $regionlist->region_id ?>"><?php echo $regionlist->region_name ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div> <!-- ./Regions -->
        ...
        <script>
            $(document).ready(function(){
                ...
                getbodyCities();
                getbodyBrgy();
                /*$('#x_region_id').val('<?php echo $fbdata->region_id ?>').trigger('change');
                $('#x_prov_id').val('<?php echo $fbdata->prov_id ?>').trigger('change');
                $('#x_muni_city_id').val('<?php echo $fbdata->muni_city ?>').trigger('change');
                $('#x_brgy_id').val('<?php echo $fbdata->brgy_id ?>').trigger('change');*/
            ...
            function getbodyProv() {
                ...
                xhttp.open("GET", "<?php echo base_url('landregistration/ajaxbodyProvOpt/?region_id=') ?>" + "<?php echo $fbdata->region_id ?>" + "&prov_id=<?php echo $fbdata->prov_id ?>", true);
                xhttp.send();
            }
            ...
            function getbodyCities() {
                ...
                xhttp.open("GET", "<?php echo base_url('landregistration/ajaxbodyCitiesOpt/?prov_id=') ?>" + "<?php echo $fbdata->prov_id ?>" + "&muni_city_id=<?php echo $fbdata->muni_city ?>", true);
                xhttp.send();
            }
            ...
            function getbodyBrgy() {
                ...
                xhttp.open("GET", "<?php echo base_url('landregistration/ajaxbodyBrgyOpt/?muni_city_id=') ?>" + "<?php echo $fbdata->muni_city ?>" + "&brgy_id=<?php echo $fbdata->brgy_id ?>", true);
                xhttp.send();
            }
