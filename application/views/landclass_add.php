            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Position code -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Land classification code" name="x_land_class_code" id="x_land_class_code" maxlength="50" value="<?php echo set_value('x_land_class_code'); ?>">
                        </div>
                    </div> <!-- ./Position code -->
                    <div class="form-group"> <!-- Position name -->
                        <label for="input-text" class="col-sm-2 control-label">Land classification name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Land classification name" name="x_land_class_name" id="x_land_class_name" maxlength="50" value="<?php echo set_value('x_land_class_name'); ?>">
                        </div>
                    </div> <!-- ./Position name -->
