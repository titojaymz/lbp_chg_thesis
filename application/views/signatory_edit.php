            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Position code -->
                        <label for="input-text" class="col-sm-2 control-label">Signatory position</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Land classification code" name="x_signatory_position" id="x_signatory_position" maxlength="50" value="<?php echo $position_data->signatory_position ?>">
                        </div>
                    </div> <!-- ./Position code -->
                    <div class="form-group"> <!-- Position name -->
                        <label for="input-text" class="col-sm-2 control-label">Signatory name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Land classification name" name="x_signatory_name" id="x_signatory_name" maxlength="50" value="<?php echo $position_data->signatory_name ?>">
                        </div>
                    </div> <!-- ./Position name -->
