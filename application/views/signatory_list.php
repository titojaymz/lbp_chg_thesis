    ...
    <div class="content">
                        ...
                        <div class="table-responsive">
                            <table id="grid-data" class="table table-hover table-striped" data-toggle="bootgrid" data-ajax="true" data-url="/users/server">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="signatory_id">ID</th>
                                    <th data-column-id="signatory_position">Position</th>
                                    <th data-column-id="signatory_name">Name</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <script>
            gridSettings =
            {
                ...
                selection: false,
                sorting: true,
                url: "<?php echo base_url('signatory/rendersignatorylist'); ?>",
