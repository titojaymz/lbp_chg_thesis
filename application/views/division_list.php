    ...
    <div class="content">
                        ...
                        <div class="table-responsive">
                            <table id="grid-data" class="table table-hover table-striped" data-toggle="bootgrid" data-ajax="true" data-url="/users/server">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="division_id">ID</th>
                                    <th data-column-id="division_name">Division</th>
                                    <th data-column-id="division_short_name">Short name</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
        ...
        <script>
            gridSettings =
            {
                ...
                selection: false,
                sorting: true,
                url: "<?php echo base_url('division/renderdivisionlist'); ?>",
