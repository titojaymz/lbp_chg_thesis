...
<div class="content-page">
    ...
    <ul class="breadcrumb">
        ...
        <li><strong><?php echo $page_title?> update record</strong></li>
    </ul>
    <div class="content">
        <div class="page-heading">
            <h1><i class='icon-cogs'></i>Update <?php echo $page_title?></h1>
        </div>
        ...
        */ ?>
            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Position code -->
                        <label for="input-text" class="col-sm-2 control-label">Land classification code</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Land classification code" name="x_land_class_code" id="x_land_class_code" maxlength="50" value="<?php echo $land_class_data->land_class_code ?>">
                        </div>
                    </div> <!-- ./Position code -->
                    <div class="form-group"> <!-- Position name -->
                        <label for="input-text" class="col-sm-2 control-label">Land classification name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Land classification name" name="x_land_class_name" id="x_land_class_name" maxlength="50" value="<?php echo $land_class_data->land_class_name ?>">
                        </div>
                    </div> <!-- ./Position name -->
