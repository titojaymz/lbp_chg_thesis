...
<div class="content-page">
    ...
    <div class="content">
        <div class="page-heading">
            <h1><i class='icon-cogs'></i>Update position</h1>
        </div>
            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Position code -->
                        <label for="input-text" class="col-sm-2 control-label">Position code</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Position code" name="x_position_code" id="x_position_code" maxlength="50" value="<?php echo $position_data->position_code ?>">
                        </div>
                    </div> <!-- ./Position code -->
                    <div class="form-group"> <!-- Position name -->
                        <label for="input-text" class="col-sm-2 control-label">Position code</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Position name" name="x_position_name" id="x_position_name" maxlength="50" value="<?php echo $position_data->position_name ?>">
                        </div>
                    </div> <!-- ./Position name -->
