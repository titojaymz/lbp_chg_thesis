...
<div class="content-page">
    ...
    <ul class="breadcrumb">
        ...
        <li><strong>Landowner new record</strong></li>
    </ul>
    <div class="content">
        <div class="page-heading">
            <h1><i class='icon-cogs'></i>Landowners</h1>
        </div>
            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Last name -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_lastname" id="x_lastname" value="<?php echo set_value('x_lastname') ?>">
                        </div>
                    </div> <!-- ./Last name -->
                    <div class="form-group"> <!-- First name -->
                        <label for="input-text" class="col-sm-2 control-label">First name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_firstname" id="x_firstname" value="<?php echo set_value('x_firstname') ?>">
                        </div>
                    </div> <!-- ./First name -->
                    <div class="form-group"> <!-- Middle name -->
                        <label for="input-text" class="col-sm-2 control-label">Middle name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_middlename" id="x_middlename" value="<?php echo set_value('x_middlename') ?>">
                        </div>
                    </div> <!-- ./Middle name -->
                    <div class="form-group"> <!-- Extension name -->
                        <label for="input-text" class="col-sm-2 control-label">Extension name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_extname" id="x_extname" value="<?php echo set_value('x_extname  ') ?>">
                        </div>
                    </div> <!-- ./Extension name -->
