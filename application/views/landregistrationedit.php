...
<div class="content-page">
    ...
    <div class="content">
        ...
        */ ?>
            ...
            <body onload="getbodyCities();getbodyBrgy();"></body>
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group"> <!-- Lot number -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Lot number" name="x_lot_no" id="x_lot_no" maxlength="50" value="<?php echo $landregistrationdata['lot_no'] ?>" required>
                        </div>
                    </div> <!-- ./Lot number -->
                    <div class="form-group"> <!-- Land use -->
                        <label for="input-text" class="col-sm-2 control-label">Land use</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Land use" name="x_land_use" id="x_land_use" maxlength="50" value="<?php echo $landregistrationdata['land_use'] ?>" required>
                        </div>
                    </div> <!-- ./Land use -->
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="x_prov_id" id="x_prov_id" onchange="getCities()" required>
                                ...
                                <?php foreach($prov_data as $provList): ?>
                                    <option value="<?php echo $provList->prov_id ?>" <?php if($provList->prov_id == $landregistrationdata['prov_id']){ echo 'selected'; }  ?>><?php echo $provList->prov_name ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div> <!-- ./Province -->
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="x_status_id" id="x_status_id" required>
                                ...
                                <?php foreach($lib_status as $statusList): ?>
                                    <option value="<?php echo $statusList->status_id ?>" <?php echo set_select('x_status_id',$landregistrationdata['status_id'],TRUE) ?>><?php echo $statusList->status_name ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div> <!-- ./Status -->
                    <div class="form-group"> <!-- Pending division -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Pending division" name="x_pending_division" id="x_pending_division" maxlength="50" value="<?php echo $landregistrationdata['pending_division'] ?>" required>
                        </div>
                    </div> <!-- ./Pending division -->
                    <div class="form-group"> <!-- Date of MOV/CVPF -->
                        <label class="col-sm-2 control-label">Date of MOV/CVPF</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control datepicker-input" data-mask="9999-99-99" placeholder="yyyy-mm-dd" name="x_date_mov_cvpf" id="x_date_mov_cvpf" value="<?php echo $landregistrationdata['date_mov_cvpf'] ?>" required>
                        </div>
                    </div> <!-- ./Date of MOV/CVPF -->
                    <div class="form-group"> <!-- Date of COD -->
                        <label class="col-sm-2 control-label">Date of COD</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control datepicker-input" data-mask="9999-99-99" placeholder="yyyy-mm-dd" name="x_date_cod" id="x_date_cod" value="<?php echo $landregistrationdata['date_cod'] ?>" required>
                        </div>
                    </div> <!-- ./Date of COD -->
                    <div class="form-group"> <!-- Date of last ammended -->
                        <label class="col-sm-2 control-label">Date of last ammended</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control datepicker-input" data-mask="9999-99-99" placeholder="yyyy-mm-dd" name="x_date_last_ammended" id="x_date_last_ammended" value="<?php echo $landregistrationdata['date_last_ammended'] ?>" required>
                        </div>
                    </div> <!-- ./Date of last ammended -->
                    <div class="form-group"> <!-- Date of Returned-->
                        <label class="col-sm-2 control-label">Date of Returned</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control datepicker-input" data-mask="9999-99-99" placeholder="yyyy-mm-dd" name="x_date_returned" id="x_date_returned" value="<?php echo $landregistrationdata['date_returned'] ?>" required>
                        </div>
        ...
        <script>
            ...
            function getbodyBrgy() {
                ...
                xhttp.open("GET", "<?php echo base_url('landregistration/ajaxbodyBrgyOpt/?muni_city_id=') ?>" + "<?php echo $landregistrationdata['muni_city_id'] ?>" + "&brgy_id=<?php echo $landregistrationdata['brgy_id'] ?>", true);
                xhttp.send();
            }
