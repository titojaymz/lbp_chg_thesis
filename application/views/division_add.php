            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Position code -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Division" name="x_division_name" id="x_division_name" maxlength="50" value="<?php echo set_value('x_division_name'); ?>">
                        </div>
                    </div> <!-- ./Position code -->
                    <div class="form-group"> <!-- Position name -->
                        <label for="input-text" class="col-sm-2 control-label">Short name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Short name" name="x_division_short_name" id="x_division_short_name" maxlength="50" value="<?php echo set_value('x_division_short_name'); ?>">
                        </div>
                    </div> <!-- ./Position name -->
