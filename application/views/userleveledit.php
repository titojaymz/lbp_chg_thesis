...
<div class="content-page">
    ...
    <div class="content">
        <div class="page-heading">
            <h1><i class='icon-cogs'></i>Edit</h1>
        </div>
            ...
            <div class="widget-content padding">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group"> <!-- Date Received from DAR -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="x_userlevelname" id="x_userlevelname" value="<?php echo $userleveldata->userlevelname ?>" required>
                        </div>
